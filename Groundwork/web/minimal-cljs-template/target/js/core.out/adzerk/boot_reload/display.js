...
return (function (p__3102){
var vec__3103 = p__3102;
var attr = cljs.core.nth.call(null,vec__3103,(0),null);
var v = cljs.core.nth.call(null,vec__3103,(1),null);
...
var len__4497__auto___3110 = arguments.length;
var i__4498__auto___3111 = (0);
while(true){
if((i__4498__auto___3111 < len__4497__auto___3110)){
args__4500__auto__.push((arguments[i__4498__auto___3111]));

var G__3112 = (i__4498__auto___3111 + (1));
i__4498__auto___3111 = G__3112;
continue;
} else {
}
break;
...
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(argseq__4501__auto__);
});
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq3109){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq3109));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__3113){
var map__3114 = p__3113;
var map__3114__$1 = ((((!((map__3114 == null)))?(((((map__3114.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__3114.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__3114):map__3114);
var data = map__3114__$1;
var message = cljs.core.get.call(null,map__3114__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__3114__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__3114__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__3116 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__3116,goog.events.EventType.CLICK,((function (G__3116,map__3114,map__3114__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__3116,map__3114,map__3114__$1,data,message,line,file))
);

return G__3116;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__3117){
var map__3118 = p__3117;
var map__3118__$1 = ((((!((map__3118 == null)))?(((((map__3118.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__3118.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__3118):map__3118);
var data = map__3118__$1;
var message = cljs.core.get.call(null,map__3118__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__3118__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__3118__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__3120 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),message),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),["at line ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(line)].join('')),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),file)], null));
goog.events.listen(G__3120,goog.events.EventType.CLICK,((function (G__3120,map__3118,map__3118__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__3120,map__3118,map__3118__$1,data,message,line,file))
);
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__3121){
var map__3122 = p__3121;
var map__3122__$1 = ((((!((map__3122 == null)))?(((((map__3122.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__3122.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__3122):map__3122);
var messages = map__3122__$1;
var warnings = cljs.core.get.call(null,map__3122__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__3122__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__3124 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__3124,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),adzerk.boot_reload.display.logo_node.call(null,adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__3124,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__3125){
var map__3126 = p__3125;
var map__3126__$1 = ((((!((map__3126 == null)))?(((((map__3126.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__3126.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__3126):map__3126);
var messages = map__3126__$1;
var warnings = cljs.core.get.call(null,map__3126__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__3126__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__3126,map__3126__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__3126,map__3126__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = ((cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings))));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__3126,map__3126__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__3126,map__3126__$1,messages,warnings,exception))
;
...
}catch (e3128){if((e3128 instanceof Error)){
var __3129 = e3128;
} else {
throw e3128;
