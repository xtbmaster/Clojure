...
(def student-tbl (csv/parse-csv (slurp "resources/student.csv")))
(def subject-tbl (csv/parse-csv (slurp "resources/subject.csv")))
(def student-subject-tbl (csv/parse-csv (slurp "resources/student_subject.csv")))
...
(defn str-field-to-int [field rec]
  (assoc rec field
         (Integer/parseInt (get rec field))))
