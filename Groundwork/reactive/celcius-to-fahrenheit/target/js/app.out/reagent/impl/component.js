...
if((i < len)){
var k = (ks[i]);
var G__15697 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__15698 = (i + (1));
m = G__15697;
i = G__15698;
continue;
...
return (cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__15700 = c;
var G__15700__$1 = (((G__15700 == null))?null:G__15700.prototype);
if((G__15700__$1 == null)){
return null;
} else {
return (G__15700__$1["reagentRender"]);
}
})() == null)));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__15702 = c;
var G__15702__$1 = (((G__15702 == null))?null:G__15702.prototype);
if((G__15702__$1 == null)){
return null;
} else {
return (G__15702__$1["render"]);
}
})() == null)));
});
...
return (function() { 
var G__15705__delegate = function (args){
...
while (G__15706__i < G__15706__a.length) {G__15706__a[G__15706__i] = arguments[G__15706__i + 0]; ++G__15706__i;}
  args = new cljs.core.IndexedSeq(G__15706__a,0,null);
} 
return G__15705__delegate.call(this,args);};
...
return G__15705__delegate(args);
});
...
var _STAR_current_component_STAR_15709 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_15709;
}});
...
return ((function (G__15710,G__15710__$1){
...
var or__7978__auto__ = reagent.impl.util._STAR_always_update_STAR_;
if(or__7978__auto__){
...
var c = this;
var G__15711_15713 = (c["cljsRatom"]);
if((G__15711_15713 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__15711_15713);
}
...
if(cljs.core.truth_((function (){var and__7966__auto__ = wrap;
...
var renders_15715 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_15716 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_15715));
if((cljs.core.count.call(null,renders_15715) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_15715))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_15716)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,render_fun_15716))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}


var render_fun = (function (){var or__7978__auto__ = new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__7978__auto__)){
return or__7978__auto__;
} else {
...
var render_fun__$1 = (function (){var or__7978__auto__ = render_fun;
if(cljs.core.truth_(or__7978__auto__)){
return or__7978__auto__;
} else {
...
var name = [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__7978__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__7978__auto__)){
return or__7978__auto__;
} else {
...
var name__$1 = (function (){var G__15714 = name;
switch (G__15714) {
case "":
...
var G__15718 = o;
(G__15718[cljs.core.name.call(null,k)] = v);
...
var name = (function (){var G__15719 = fiber;
var G__15719__$1 = (((G__15719 == null))?null:(G__15719["type"]));
if((G__15719__$1 == null)){
return null;
} else {
return (G__15719__$1["displayName"]);
}
})();
var parent = (function (){var G__15720 = fiber;
if((G__15720 == null)){
return null;
} else {
return (G__15720["return"]);
}
})();
var path = (function (){var G__15721 = parent;
var G__15721__$1 = (((G__15721 == null))?null:reagent.impl.component.fiber_component_path.call(null,G__15721));
if((G__15721__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__15721__$1)," > "].join('');
}
})();
...
var temp__4655__auto__ = (function (){var G__15722 = c;
if((G__15722 == null)){
return null;
} else {
return (G__15722["_reactInternalFiber"]);
}
})();
...
var elem = (function (){var G__15723 = (function (){var or__7978__auto__ = (function (){var G__15725 = c;
if((G__15725 == null)){
return null;
} else {
return (G__15725["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__7978__auto__)){
return or__7978__auto__;
...
return (G__15723["_currentElement"]);
}
})();
var name = (function (){var G__15726 = elem;
var G__15726__$1 = (((G__15726 == null))?null:(G__15726["type"]));
...
var path = (function (){var G__15727 = elem;
var G__15727__$1 = (((G__15727 == null))?null:(G__15727["_owner"]));
var G__15727__$2 = (((G__15727__$1 == null))?null:reagent.impl.component.component_path.call(null,G__15727__$1));
if((G__15727__$2 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__15727__$2)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_.call(null,res)){
...
var n = (function (){var or__7978__auto__ = reagent.impl.component.component_path.call(null,c);
if(cljs.core.truth_(or__7978__auto__)){
return or__7978__auto__;
} else {
var G__15728 = c;
var G__15728__$1 = (((G__15728 == null))?null:G__15728.constructor);
if((G__15728__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__15728__$1);
}
}
})();
